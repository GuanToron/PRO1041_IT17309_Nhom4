...
public class FormTraHang extends javax.swing.JFrame {
    ...
    private final DefaultTableModel modelTH = new DefaultTableModel();
    ...
    private DefaultTableModel defauth;
    private final HoaDonCTVMServiccecInterface hdct = new HoaDonCTVMServiceImplement();
    private final HoaDonVMServiceInterface hoadonVMServiceInterface;
    private final List<HoaDonVM> list;
    ...
    public FormTraHang() {
        ...
        tbltrahang.setModel(modelTH);
        loadTableTH(listTraHang);
//        loadTraH(listTraHang);
    }
...
//        }
        ...
        modelTH.setColumnIdentifiers(new String[]{"Mã PTH", "Mã HĐ", "Mã KH", "Mã NV", "Ngày Trả", "Số Tiền Trả Lại", "Lý Do Trả"});
        for (QLTraHang x : list) {
            modelTH.addRow(x.toDataRow());
        }
    }
...
//    private void loadTraH(ArrayList<QLTraHang> listth) {
//        defauth = (DefaultTableModel) tbltrahang.getModel();
//        defauth.setRowCount(0);
//        for (QLTraHang qLTraHang : listth) {
//            defauth.addRow(new Object[]{
//                qLTraHang.getMaPTH(),
//                qLTraHang.getMaHD(),
//                qLTraHang.getMaKH(),
//                qLTraHang.getMaNV(),
//                qLTraHang.getNgayTra(),
//                qLTraHang.getTienTraLai(),
//                qLTraHang.getLyDo()
//
//            });
//        }
...
//    }
    ...
    private void initComponents() {
        ...
        lbmapth = new javax.swing.JLabel();
                                        ...
                                        .addGroup(SidePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(SidePanelLayout.createSequentialGroup()
                                                ...
                                                .addGroup(SidePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                    ...
                                                    .addComponent(lbmapth, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                                        .addGroup(SidePanelLayout.createSequentialGroup()
                    ...
                    .addGroup(SidePanelLayout.createSequentialGroup()
                        ...
                        .addGroup(SidePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, SidePanelLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(btntimkiemhoadon, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(19, 19, 19))))))
        );

        SidePanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btnThongKe, jButton1});

        SidePanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {txtlydo, txtmahd, txtmakh, txtmanv, txtngaytao, txtngaytra, txtsotientralai, txttongtien});
        ...
        SidePanelLayout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {txtlydo, txtmahd, txtmakh, txtmanv, txtngaytao, txtngaytra, txtsotientralai, txttongtien});
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(SidePanel, javax.swing.GroupLayout.PREFERRED_SIZE, 809, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
...
//        // TODO add your handling code here:
    ...
    private void btntimkiemhoadonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btntimkiemhoadonActionPerformed
        // TODO add your handling code here:
         Integer maHoaDon = Integer.valueOf(txttimkiemhoadon.getText());
    ...
    private javax.swing.JLabel lbmapth;
