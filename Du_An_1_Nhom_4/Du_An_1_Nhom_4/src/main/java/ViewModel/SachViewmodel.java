...
public class SachViewmodel {
    ...
    public Object[] todDataRow() {
        return new Object[]{maSach, tenSach, tenDanhMuc, tenTheLoai, tenNPH, tenTacGia, tenNXB, namxuatban, ngonNgu, nhomTuoi, taiBan, sotrang, giaban, soluong, trangthai==1?"Đang bán":"Không còn bán"};
    }
}
